                ...
                <nav>
                  <ul className="mobile-menu font-heading">
                    ...
                    >
                      ...
                      >
                        <li>
                          <Link href="/destination">Destinations list 1</Link>
                        </li>
                        <li>
                          <Link href="/destination-2">Destinations list 2</Link>
                        </li>
                        <li>
                          <Link href="/destination-3">Destinations list 3</Link>
                        </li>
                        <li>
                      ...
                      >
                        <li>
                          <Link href="/activities">
                            Activities List - Top Fillter
                          </Link>
                        </li>
                        <li>
                          <Link href="/activities-2">
                            Activities List - Sidebar Left Fillter
                          </Link>
                        </li>
                        <li>
                          <Link href="/activities-3">
                            Activities List - Sidebar Right Fillter
                          </Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link href="/activities-detail">
                            Activities Single 01 - Gallery
                          </Link>
                        </li>
                        <li>
                          <Link href="/activities-detail-2">
                            Activities Single 02 - Slideshow
                          </Link>
                        </li>
                        <li>
                    ...
                    >
                      ...
                      >
                        ...
                        <li>
                          <Link href="/privacy">Invoice</Link>
                        </li>
                        <li>
