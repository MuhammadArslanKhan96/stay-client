          ...
          <div className="container-fluid">
            <div className="text-header">
              <div className="text-unlock text-sm-bold">
                Unlock the Magic of Travel with Stay Chain - Your Gateway to
                Extraordinary Experiences
              </div>
              <Link className="link-secondary-2" href="#">
                Get This Now
                <svg
        ...
        <div className="container-fluid background-body">
          <div className="main-header">
                        ...
                        <div className="mega-menu-inner">
                          <div className="row align-items-center">
                              ...
                              <div className="row align-items-center">
                                <div className="col-lg-4">
                                  ...
                                  <h5 className="mb-45 neutral-1000">
                                    Book, Pack, Go! Your Ultimate Travel
                                    Companion
                                  </h5>
                                  <Link
                                    href="#"
                                ...
                                <div className="col-lg-4">
                                    ...
                                    <div className="card-info">
                                      ...
                                      <Link href="/">
                                        <h6 className="text-md-bold">
                                          Home 01 - All Services
                                        </h6>
                                      </Link>
                                      <p className="text-xs-medium neutral-500">
                                        Tours, Activities, Destinations, Hotels,
                                        Rental, Tickets
                                      </p>
                                    </div>
                                  </div>
                                  <div className="card-home-link background-body">
                                    {" "}
                                    <Link className="card-icon" href="/index-2">
                                      {" "}
                                      <img
                                  ...
                                  <div className="card-home-link background-body">
                                    {" "}
                                    <Link className="card-icon" href="/index-3">
                                      {" "}
                                      <img
                                        src="/assets/imgs/template/icons/deck-chair.svg"
                                        alt="StayChain"
                                      />
                                    </Link>
                                    <div className="card-info">
                                ...
                                <div className="col-lg-4">
                                  <ul className="list-featured">
                                    <li>
                                      <Link className="tours" href="/index-4">
                                        Home 04 - Tours
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link
                                        ...
                                        href="/index-6"
                                      >
                                        Home 06 - Destinations
                                      </Link>
                                    </li>
                                    <li>
                                      <Link className="hotels" href="/index-7">
                                        Home 07 - Hotels
                                      </Link>
                                    </li>
                                    <li>
                            ...
                            <div className="col-lg-2">
                              <img
                                src="/assets/imgs/template/world.png"
                                alt="StayChain"
                              />
                            </div>
                          </div>
            ...
            <div className="header-right">
              {/* <LanguageDropdown /> */}
              {/* <CurrencyDropdown /> */}
              <div className="d-none d-xxl-flex align-items-center mr-15 ">
                <ThemeSwitch />
