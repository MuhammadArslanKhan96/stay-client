				...
				<div className="top-bar">
					<div className="container-fluid">
						<div className="text-header">
							<div className="text-unlock text-sm-bold">Unlock the Magic of Travel with Stay Chain - Your Gateway to
				...
				<div className="container-fluid background-body">
					<div className="main-header">
						<div className="header-left">
							<div className="header-logo"><Link className="d-flex" href="/"><img className="light-mode" alt="StayChain" src="/assets/imgs/template/logo.svg" /><img className="dark-mode" alt="StayChain"  src="/assets/imgs/template/logo-w.svg" /></Link></div>
													...
													<div className="row align-items-center">
														<div className="col-lg-10">
															<div className="row align-items-center">
																...
																<div className="col-lg-4">
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/"> <img src="/assets/imgs/template/icons/activity.svg" alt="StayChain" /></Link>
																	...
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/index-2"> <img src="/assets/imgs/template/icons/map.svg" alt="StayChain" /></Link>
																	...
																	<div className="card-home-link background-body"> <Link className="card-icon" href="/index-3"> <img src="/assets/imgs/template/icons/deck-chair.svg" alt="StayChain" /></Link>
														...
														<div className="col-lg-2"><img src="/assets/imgs/template/world.png" alt="StayChain" /></div>
													</div>
												</div>
											</div>
										</li>
						...
						<div className="header-right">
							...
							<div className="burger-icon-2 burger-icon-white" onClick={handleSidebar}>
								<img src="/assets/imgs/template/icons/menu.svg" alt="StayChain" />
							</div>
