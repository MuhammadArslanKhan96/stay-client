        ...
        <>
            <footer className="footer footer-type-3 background-body">
                <div className="container">
                    <div className="row">
                        <div className="col-md-4 mb-30"> <Link className="d-inline-block mb-20" href="/"><img className="light-mode" alt="StayChain" src="/assets/imgs/template/logo-footer2.svg" /><img className="dark-mode" alt="StayChain" src="/assets/imgs/template/logo-footer.svg" /></Link>
                    ...
                    <div className="footer-bottom">
                        <div className="row align-items-center">
                            <div className="col-md-6 text-md-start text-center mb-20">
                                <p className="text-sm neutral-500">© {new Date().getFullYear()} Stay Chain Inc. All rights reserved.</p>
                            </div>
