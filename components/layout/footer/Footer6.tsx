					...
					<div className="container-footer">
						<div className="row">
							<div className="col-lg-3 col-sm-12">
								<div className="mt-20 mb-20"><a className="d-inline-block mb-20" href="index.html"><img alt="StayChain" src="assets/imgs/template/logo-footer.svg" /></a>
						...
						<div className="footer-bottom mt-50">
							<div className="row align-items-center">
								<div className="col-md-6 text-md-start text-center mb-20">
									<p className="text-sm color-white">© 2024 Stay Chain Inc. All rights reserved.</p>
								</div>
