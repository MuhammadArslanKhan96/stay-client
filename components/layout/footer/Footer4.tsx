                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-sm-12">
                            <div className="mb-20"><Link className="d-inline-block mb-20" href="/"><img alt="StayChain" src="/assets/imgs/template/logo-footer.svg" /></Link>
                                <div className="box-info-contact mt-0">
                                    ...
                                    <p className="text-md neutral-400 icon-email">support@staychain.com</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="box-footer-col-3">
                        <div className="footer-col-1">
                            <div className="box-footer-help"><img alt="StayChain" src="/assets/imgs/page/homepage6/help.svg" />
                        ...
                        <div className="footer-col-2">
                            <div className="box-join"><img alt="StayChain" src="/assets/imgs/page/homepage6/join.svg" /><span className="text-xl-bold">Join Stay Chain Affiliate Program Today !</span></div>
                        </div>
                        <div className="footer-col-3">
                            <div className="box-send-message"> <img alt="StayChain" src="/assets/imgs/page/homepage6/msg.svg" />
                    ...
                    <div className="footer-bottom mt-50">
                        <div className="row align-items-center">
                            <div className="col-md-6 text-md-start text-center mb-20">
                                <p className="text-sm color-white">© {new Date().getFullYear()} Stay Chain Inc. All rights reserved.</p>
                            </div>
