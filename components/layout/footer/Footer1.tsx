                ...
                <div className="container">
                    <div className="footer-top">
                        <div className="row align-items-center">
                            <div className="col-md-4 text-center text-md-start"><Link className="d-inline-block" href="/"><img alt="StayChain" src="/assets/imgs/template/logo-footer.svg" /></Link></div>
