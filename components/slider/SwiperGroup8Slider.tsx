			...
			<Swiper {...swiperGroup8}>
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/eiffel-tower.png" alt="StayChain" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/MachuPicchu.png" alt="StayChain" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/GreatWall.png" alt="StayChain" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/StatueofLiberty.png" alt="StayChain" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/TajMahal.png" alt="StayChain" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/OperaHouse.png" alt="StayChain" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/Colosseum.png" alt="StayChain" /></div>
				...
				<SwiperSlide>
					<div className="card-popular-destination">
						<div className="card-image"> <img src="/assets/imgs/page/homepage3/GrandCanyon.png" alt="StayChain" /></div>
