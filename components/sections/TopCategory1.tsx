                        ...
                        <div className="row">
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top.png" alt="StayChain" />
                                    </div>
                                    <div className="card-info"> <Link className="card-title" href="/destination-2">Mountain</Link>
                                        <div className="card-meta">
                                            <div className="meta-links"> <Link href="#">356 Tours, </Link><Link href="#">248
                                                Activities</Link></div>
                                            <div className="card-button"> <Link href="/destination-2">
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top2.png" alt="StayChain" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top3.png" alt="StayChain" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top4.png" alt="StayChain" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top5.png" alt="StayChain" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top6.png" alt="StayChain" />
                                    </div>
                            ...
                            <div className="col-lg-3 col-sm-6">
                                <div className="card-popular background-card hover-up">
                                    <div className="card-image"> <img src="/assets/imgs/page/homepage2/top7.png" alt="StayChain" />
                                    </div>
