                            ...
                            <div className="col-lg-4 col-md-6 wow fadeIn">
                                <div className="card-journey-small background-card">
                                    ...
                                    <div className="card-info background-card">
                                        ...
                                        <div className="card-title"> <Link className="heading-6 neutral-1000" href="#">California
                                        ...
                                        <div className="card-program">
                                            ...
                                            <div className="endtime">
                                                ...
                                                <div className="card-button"> <Link className="btn btn-gray" href="#">Book Now</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4 col-md-6 wow fadeIn">
                                <div className="card-journey-small background-card">
                                    ...
                                    <div className="card-info background-card">
                                        ...
                                        <div className="card-title"> <Link className="heading-6 neutral-1000" href="#">NYC: Food
                                            Tastings and Culture Tour</Link></div>
                                        <div className="card-program">
                                            <div className="card-duration-tour">
                            ...
                            <div className="col-lg-4 col-md-6 wow fadeIn">
                                <div className="card-journey-small background-card">
                                    ...
                                    <div className="card-info background-card">
                                        ...
                                        <div className="card-title"> <Link className="heading-6 neutral-1000" href="#">Grand Canyon
                                            Horseshoe Bend 2 days</Link></div>
                                        <div className="card-program">
                                            <div className="card-duration-tour">
