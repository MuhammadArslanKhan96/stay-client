								...
								<SwiperSlide>
									<div className="item-banner-box">
										<div className="item-banner-box-inner"> <span className="btn btn-brand-secondary">Luxury
											...
											<div className="download-apps"> <Link href="#"><img src="/assets/imgs/template/googleplay.png" alt="StayChain" /></Link><Link href="#"><img src="/assets/imgs/template/appstore.png" alt="StayChain" /></Link>
											</div>
										</div>
									</div>
								</SwiperSlide>
