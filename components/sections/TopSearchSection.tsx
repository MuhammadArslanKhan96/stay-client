            ...
            <section className="section-box box-top-search-section background-body">
                <div className="container">
                    <div className="text-center wow fadeInUp">
                        <h2 className="neutral-1000 wow fadeInUp">Top Searched Destinations</h2>
                        <p className="text-xl-medium neutral-500 wow fadeInUp">Favorite destinations of professional tourists
                        </p>
                    </div>
