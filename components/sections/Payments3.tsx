					...
					<div className="row align-items-center">
						...
						<div className="col-lg-5 mb-30 text-center text-lg-end wow fadeInUp">
							<div className="box-video-payment">
								<div className="dot-payment"> <img src="/assets/imgs/page/homepage4/dot-payment.png" alt="StayChain" /></div>
								<div className="img-sm-payment"> <img src="/assets/imgs/page/homepage4/img-payment-sm.png" alt="StayChain" /></div>
								<div className="review-payment"> <img className="light-mode" src="/assets/imgs/page/homepage4/img-review.png" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/page/homepage4/img-review-dark.png" alt="StayChain" /></div>
								<div className="card-video">
									<div className="card-image">
										<VideoPopup vdocls="btn btn-play popup-youtube" />
										<img src="/assets/imgs/page/homepage4/img-payment.png" alt="StayChain" /></div>
								</div>
							</div>
						</div>
					</div>
