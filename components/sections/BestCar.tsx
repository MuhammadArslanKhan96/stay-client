                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 mb-30 wow fadeInUp">
                            <div className="box-image-3-col">
                                <div className="img-col"> <img src="/assets/imgs/page/homepage8/best-car.png" alt="StayChain" /><img src="/assets/imgs/page/homepage8/best-car2.png" alt="StayChain" /></div>
                                <div className="img-col"> <img src="/assets/imgs/page/homepage8/best-car3.png" alt="StayChain" /><img src="/assets/imgs/page/homepage8/best-car4.png" alt="StayChain" /></div>
                                <div className="img-col"> <img src="/assets/imgs/page/homepage8/best-car5.png" alt="StayChain" /><img src="/assets/imgs/page/homepage8/best-car6.png" alt="StayChain" /></div>
                            </div>
                        </div>
