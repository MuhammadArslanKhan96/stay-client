        ...
        <>
            ...
            <section className="section-box box-top-rated-3 box-nearby background-body">
                <div className="container">
                    ...
                    <p className="text-xl-medium neutral-500 wow fadeInUp">Quality as judged by customers. Book at the ideal
                        price!</p>
                    <div className="box-button-tabs wow fadeInUp"> <Link className="btn btn-white" href="/activities">All</Link><Link className="btn btn-white" href="/activities">Luxury</Link><Link className="btn btn-white" href="/activities">Standard</Link><Link className="btn btn-white" href="/activities">Villa</Link><Link className="btn btn-white" href="/activities">Cottages</Link><Link className="btn btn-white" href="/activities">Townhouses</Link><Link className="btn btn-white" href="/activities">Shared
                        Space</Link></div>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp">
                            <div className="card-journey-small card-journey-small-type-3 background-card">
                                ...
                                <div className="card-info">
                                    ...
                                    <div className="card-title"> <Link className="text-lg-bold neutral-1000" href="/activities">California Sunset/Twilight Boat Cruise </Link></div>
                                    <div className="card-program">
                                        ...
                                        <div className="endtime">
                                            ...
                                            <div className="card-button"> <Link className="btn btn-gray" href="/tour-detail-3">Book
                                                Now</Link></div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp">
                            <div className="card-journey-small card-journey-small-type-3 background-card">
                                ...
                                <div className="card-info">
                                    ...
                                    <div className="card-title"> <Link className="text-lg-bold neutral-1000" href="/activities">NYC: Food Tastings and Culture Tour</Link></div>
                                    <div className="card-program">
                                        <div className="card-location">
                                            <p className="text-location text-md-medium neutral-500">Manchester, England</p>
                                            <p className="text-star"> <img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /></p>
                        ...
                        <div className="col-lg-4 col-md-6 wow fadeInUp">
                            <div className="card-journey-small card-journey-small-type-3 background-card">
                                ...
                                <div className="card-info">
                                    ...
                                    <div className="card-title"> <Link className="text-lg-bold neutral-1000" href="/activities">Grand Canyon Horseshoe Bend 2 days</Link></div>
                                    <div className="card-program">
                                        <div className="card-location">
                                            <p className="text-location text-md-medium neutral-500">Manchester, England</p>
                                            <p className="text-star"> <img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="light-mode" src="/assets/imgs/template/icons/star-black.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/template/icons/star-w.svg" alt="StayChain" /></p>
