		...
		<>
			...
			<section className="section-box box-banner-home4 background-body">
				...
				<div className="container">
					...
					<div className="box-image-banner-home4"><img src="/assets/imgs/page/homepage4/banner.png" alt="StayChain" />
						<div className="shape-rate"> <img className="light-mode" src="/assets/imgs/page/homepage4/review.png" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/page/homepage4/review-dark.png" alt="StayChain" /></div>
						<div className="shape-phone"><img className="light-mode" src="/assets/imgs/page/homepage4/hotline.png" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/page/homepage4/hotline-dark.png" alt="StayChain" /></div>
					</div>
				</div>
			</section>
		</>
