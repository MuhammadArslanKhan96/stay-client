                            ...
                            <div className="box-list-flights">
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/logo1.png" alt="StayChain" />
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/tokyo.png" alt="StayChain" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/sydney.png" alt="StayChain" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/dubai.png" alt="StayChain" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/los.png" alt="StayChain" />
                                            <div className="flight-info">
                                ...
                                <div className="item-flight background-card border-1">
                                    <div className="flight-route">
                                        <div className="flight-name"> <img src="/assets/imgs/page/homepage10/paris.png" alt="StayChain" />
                                            <div className="flight-info">
