                    ...
                    <div className="row mt-60 align-items-center">
                        <div className="col-lg-6 wow fadeInUp">
                            <div className="box-image-how">
                                <div className="image-top-how"> <img src="/assets/imgs/page/homepage4/img-how.png" alt="StayChain" />
                                </div>
                                <div className="image-bottom-how"> <img src="/assets/imgs/page/homepage4/img-how2.png" alt="StayChain" /><img src="/assets/imgs/page/homepage4/img-how3.png" alt="StayChain" />
                                    <div className="shape"> <img className="light-mode" src="/assets/imgs/page/homepage4/wave.png" alt="StayChain" /><img className="dark-mode" src="/assets/imgs/page/homepage4/wave-dark.png" alt="StayChain" /></div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="card-why-travel card-why-travel-2 background-1 wow fadeInUp">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/security.svg" alt="StayChain" />
                                </div>
                            ...
                            <div className="card-why-travel card-why-travel-2 background-2 wow fadeInUp">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/support.svg" alt="StayChain" />
                                </div>
                            ...
                            <div className="card-why-travel card-why-travel-2 background-3 wow fadeInUp">
                                <div className="card-image"> <img src="/assets/imgs/page/homepage2/policy.svg" alt="StayChain" />
                                </div>
