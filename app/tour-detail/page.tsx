            ...
            <ul className="breadcrumbs">
              ...
              <li>
                ...
                <span className="text-breadcrumb">
                  The High : Tickets for The LINQ Observation Wheel, Las Vegas
                  Strip
                </span>
              </li>
            </ul>
            ...
            <div className="row">
                ...
                <div className="row">
                  <div className="col-lg-12 col-sm-6">
                    <div className="banner-detail-1">
                      {" "}
                      <img
                        src="/assets/imgs/page/tour-detail/banner.png"
                        alt="Travile"
                      />
                    </div>
                  </div>
                  <div className="col-lg-12 col-sm-6">
                    <div className="banner-detail-2">
                      {" "}
                      <img
                        src="/assets/imgs/page/tour-detail/banner2.png"
                        alt="Travile"
                      />
                    </div>
                  </div>
              ...
              <div className="col-xl-4 col-lg-12">
                <div className="banner-detail-3">
                  {" "}
                  <img
                    src="/assets/imgs/page/tour-detail/banner3.png"
                    alt="Travile"
                  />
                </div>
              </div>
              <div className="col-xl-4 col-lg-12">
                <div className="row">
                  <div className="col-sm-6">
                    <div className="banner-detail-4">
                      {" "}
                      <img
                        src="/assets/imgs/page/tour-detail/banner4.png"
                        alt="Travile"
                      />
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="banner-detail-5">
                      {" "}
                      <img
                        src="/assets/imgs/page/tour-detail/banner5.png"
                        alt="Travile"
                      />
                    </div>
                  </div>
                ...
                <div className="banner-detail-6">
                  {" "}
                  <img
                    src="/assets/imgs/page/tour-detail/banner6.png"
                    alt="Travile"
                  />
                </div>
              </div>
                    ...
                    >
                      <div className="card card-body">
                        <p>
                          ...
                          stretching as far as the eye can see. From the iconic
                          landmarks of the Strip to the majestic mountains in
                          the distance, every moment aboard The High Roller
                          promises breathtaking sights and unforgettable
                          memories.
                        </p>
                        <p>
                          All rooms at the resort come with air conditioning, a
                          seating area, a flat-screen TV with satellite
                          channels, a safety deposit box and a private bathroom
                          with a shower, free toiletries and a hairdryer. At
                      ...
                      <div className="card card-body">
                        <div className="row">
                          <div className="col-lg-6">
                            ...
                            <ul>
                              <li>
                                Admission ticket to The High Roller at The LINQ.
                              </li>
                    ...
                    >
                      <div className="card card-body">
                        ...
                        <p>
                          ...
                          awe-inspiring experience, The High Roller promises to
                          be the highlight of your Las Vegas adventure.
                        </p>
                      </div>
                    </div>
                  </div>
