...
export default function TourDetail() {
    ...
    useEffect(()=>{
        const hotels:any = sessionStorage.getItem('hotel') || {};
        const hotelObj = JSON.parse(hotels);
                ...
                <section className="box-section box-breadcrumb background-body">
                    <div className="container">
                        <ul className="breadcrumbs">
                            ...
                            <li> <Link href="/destination">Booking</Link><span className="arrow-right">
                                <svg width={7} height={12} viewBox="0 0 7 12" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 11L6 6L1 1" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                                </svg></span></li>
                            <li> <span className="text-breadcrumb">{hotel?.name?.toUpperCase()}</span></li>
                        </ul>
                    </div>
                </section>
                {/* Body images */}
                    ...
                    <div className="container">
                        <div className="tour-header">
                            <div className="tour-rate">
                                <div className="rate-element"><span className="rating">{hotel?.rating} <span className="text-sm-medium neutral-500">({hotel?.rating_count} reviews)</span></span></div>
                            </div>
                            <div className="row">
                                <div className="col-lg-8">
                                    <div className="tour-title-main">
                                        <h4 className="neutral-1000">{hotel?.name?.toUpperCase()}</h4>
                                    </div>
                                </div>
                            </div>
                            <div className="tour-metas">
                                <div className="tour-meta-left">
                                    ...
                                    </p><Link className="text-md-medium neutral-1000" href="#">{selectedRoom?.name}</Link>
                                </div>
                        ...
                        <div className="row mt-30">
                            ...
                            <div className="col-lg-4">
                                <div className="booking-form">
                                    ...
                                    <BookingForm room={selectedRoom} hotel={hotel}/>
                                </div>
                                ...
                                <div className="sidebar-banner"> <Link href="#"><img src="/assets/imgs/page/tour-detail/banner-ads.png" alt="StayChain" /></Link></div>
                                <div className="sidebar-banner"> <Link href="#"><img src="/assets/imgs/page/tour-detail/banner-ads2.png" alt="StayChain" /></Link></div>
                            </div>
                        </div>
                    </div>
                </section>
...
function BookingForm(props:any) {
    ...
    const handleBooking = async (event:any)=>{
        ...
        const hash = "undeveloped";
        const store:any = localStorage.getItem('dynamic_store');
        const storeJson = JSON.parse(store);
        const email = storeJson?.state?.user?.email;
        if(!email){
            alert("Must be login to book the room.");
            return;
        }
        try{
            setLoading(true);
            const bodyData = {roomId, hotelId, userEmail:email, hash, startTime:startTime.toISOString(), endTime:endTime.toISOString(), duration, price}
            ...
            console.log("API response from bookings...");
	...
	return (
		<>
			<div className="content-booking-form">
				<div className="item-line-booking"> <strong className="text-md-bold neutral-1000">Check In:</strong>
					<div className="input-calendar">
						<input className="form-control calendar-date" type="date" required={true} onChange={(e)=>{e.preventDefault();
				...
				<div className="item-line-booking"> <strong className="text-md-bold neutral-1000">Check Out:</strong>
					<div className="input-calendar">
						<input className="form-control calendar-date" type="date" required={true} onChange={(e)=>{
                            e.preventDefault();
				...
				<div className="item-line-booking">
                    <div className="box-tickets"><strong className="text-md-bold neutral-1000">Room</strong>
						<div className="line-booking-tickets">
							<div className="item-ticket">
								<p className="text-md-medium neutral-500 mr-30">{roomDetails?.name?.toUpperCase()}</p>
							</div>
						</div>
					</div>
					<div className="box-tickets"><strong className="text-md-bold neutral-1000">Location</strong>
						<div className="line-booking-tickets">
							<div className="item-ticket">
								<p className="text-md-medium neutral-500 mr-30">{hotel?.city?.toUpperCase()}</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div className="item-line-booking last-item"> <strong className="text-md-bold neutral-1000">Total:</strong>
					<div className="line-booking-right">
						<p className="text-xl-bold neutral-1000">${roomDetails?.price}</p>
					</div>
				</div>
                {
                    loading ? (<>
                    ...
                    </>):(<div className="box-button-book" onClick={handleBooking}> <a className="btn btn-book" href="#">Book Now
