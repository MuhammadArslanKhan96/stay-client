						...
						<div className="container">
							<div className="row">
								<div className="col-lg-6 mb-30">
									...
									<h6 className="neutral-500">Discover the World's Treasures with Stay Chain </h6>
								</div>
								<div className="col-lg-6 mb-30">
											...
											<Swiper {...swiperGroup5}>
												<SwiperSlide>
													<div className="card-popular-destination card-popular-destination-type-2">
														<div className="card-image"> <img src="/assets/imgs/page/homepage5/activity.png" alt="StayChain" /></div>
												...
												<SwiperSlide>
													<div className="card-popular-destination card-popular-destination-type-2">
														<div className="card-image"> <img src="/assets/imgs/page/homepage5/activity2.png" alt="StayChain" /></div>
												...
												<SwiperSlide>
													<div className="card-popular-destination card-popular-destination-type-2">
														<div className="card-image"> <img src="/assets/imgs/page/homepage5/activity3.png" alt="StayChain" /></div>
												...
												<SwiperSlide>
													<div className="card-popular-destination card-popular-destination-type-2">
														<div className="card-image"> <img src="/assets/imgs/page/homepage5/activity4.png" alt="StayChain" /></div>
												...
												<SwiperSlide>
													<div className="card-popular-destination card-popular-destination-type-2">
														<div className="card-image"> <img src="/assets/imgs/page/homepage5/activity5.png" alt="StayChain" /></div>
												...
												<SwiperSlide>
													<div className="card-popular-destination card-popular-destination-type-2">
														<div className="card-image"> <img src="/assets/imgs/page/homepage5/activity6.png" alt="StayChain" /></div>
												...
												<SwiperSlide>
													<div className="card-popular-destination card-popular-destination-type-2">
														<div className="card-image"> <img src="/assets/imgs/page/homepage5/activity7.png" alt="StayChain" /></div>
												...
												<SwiperSlide>
													<div className="card-popular-destination card-popular-destination-type-2">
														<div className="card-image"> <img src="/assets/imgs/page/homepage5/activity8.png" alt="StayChain" /></div>
									...
									<Swiper {...swiperGroupCenter4}>
										<SwiperSlide>
											<div className="card-blog">
												<div className="card-image"><img src="/assets/imgs/page/blog/blog.png" alt="StayChain" /></div>
										...
										<SwiperSlide>
											<div className="card-blog">
												<div className="card-image"><img src="/assets/imgs/page/blog/blog2.png" alt="StayChain" /></div>
												<div className="card-info">
										...
										<SwiperSlide>
											<div className="card-blog">
												<div className="card-image"><img src="/assets/imgs/page/blog/blog3.png" alt="StayChain" /></div>
												<div className="card-info">
										...
										<SwiperSlide>
											<div className="card-blog">
												<div className="card-image"><img src="/assets/imgs/page/blog/blog4.png" alt="StayChain" /></div>
												<div className="card-info">
									...
									<div className="box-grid-hotels box-grid-news mt-60 mb-50 wow fadeIn">
										<div className="card-flight card-news background-card">
											<div className="card-image"> <Link className="wish" href="#">
												...
												</svg></Link><Link href="/blog-detail"><img src="/assets/imgs/page/blog/news.png" alt="StayChain" /></Link></div>
										...
										<div className="card-flight card-news background-card">
											<div className="card-image"> <Link className="wish" href="#">
												<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
													<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
												</svg></Link><Link href="/blog-detail"><img src="/assets/imgs/page/blog/news2.png" alt="StayChain" /></Link></div>
										...
										<div className="card-flight card-news background-card">
											<div className="card-image"> <Link className="wish" href="#">
												<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
													<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
												</svg></Link><Link href="/blog-detail"><img src="/assets/imgs/page/blog/news3.png" alt="StayChain" /></Link></div>
										...
										<div className="card-flight card-news background-card">
											<div className="card-image"> <Link className="wish" href="#">
												<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
													<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
												</svg></Link><Link href="/blog-detail"><img src="/assets/imgs/page/blog/news4.png" alt="StayChain" /></Link></div>
											...
											<ul className="list-posts">
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail"><img src="/assets/imgs/page/blog/trending.png" alt="StayChain" /></Link></div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail"><img src="/assets/imgs/page/blog/trending2.png" alt="StayChain" /></Link></div>
														<div className="card-info"> <Link className="text-md-bold neutral-1000" href="/blog-detail">Beyond the Pixels: My Art-Tech Lifestyle Journey</Link>
															<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
														</div>
													</div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail"><img src="/assets/imgs/page/blog/trending3.png" alt="StayChain" /></Link></div>
														<div className="card-info"> <Link className="text-md-bold neutral-1000" href="/blog-detail">Beyond the Pixels: My Art-Tech Lifestyle Journey</Link>
															<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
														</div>
													</div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail"><img src="/assets/imgs/page/blog/trending4.png" alt="StayChain" /></Link></div>
														<div className="card-info"> <Link className="text-md-bold neutral-1000" href="/blog-detail">Beyond the Pixels: My Art-Tech Lifestyle Journey</Link>
															<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
														</div>
													</div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail"><img src="/assets/imgs/page/blog/trending5.png" alt="StayChain" /></Link></div>
														<div className="card-info"> <Link className="text-md-bold neutral-1000" href="/blog-detail">Beyond the Pixels: My Art-Tech Lifestyle Journey</Link>
															<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
														</div>
													</div>
									...
									<div className="box-sidebar-border">
										...
										<div className="box-content-sidebar">
											<ul className="list-photo-col-3">
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat.png" alt="StayChain" /></Link></li>
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat2.png" alt="StayChain" /></Link></li>
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat3.png" alt="StayChain" /></Link></li>
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat4.png" alt="StayChain" /></Link></li>
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat5.png" alt="StayChain" /></Link></li>
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat6.png" alt="StayChain" /></Link></li>
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat7.png" alt="StayChain" /></Link></li>
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat8.png" alt="StayChain" /></Link></li>
												<li> <Link href="#"><img src="/assets/imgs/page/blog/cat.png" alt="StayChain" /></Link></li>
											</ul>
										</div>
									</div>
