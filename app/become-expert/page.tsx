								...
								<div className="row">
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/earth.png" alt="StayChain" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/tour.png" alt="StayChain" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/custom.png" alt="StayChain" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/car.png" alt="StayChain" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/local.png" alt="StayChain" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/themed.png" alt="StayChain" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/ride.png" alt="StayChain" /></div>
									...
									<div className="col-lg-3 col-md-6">
										<div className="card-why-travel card-business background-card wow fadeInUp">
											<div className="card-image"> <img src="/assets/imgs/page/pages/visas.png" alt="StayChain" /></div>
							...
							<div className="block-install-apps">
								<div className="row align-items-center">
									<div className="col-lg-6 mb-40 wow fadeInLeft"><span className="btn btn-tag">Install APP   Get  discount code</span>
										...
										<p className="text-xl-medium neutral-500">Embark on a journey like never before with Stay Chain – your ultimate travel companion.</p>
