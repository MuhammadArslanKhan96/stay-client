                        ...
                        <div className="container">
                            ...
                            <div className="box-mw-824">
                                <div className="box-detail-info">
                                    <p>At Stay chain, we take your privacy seriously and are committed to  protecting your personal information. This Privacy Policy outlines how  we collect, use, disclose, and safeguard your data when you use our  website or services.</p>
                                    ...
                                    <p>If you have any questions or concerns about our Privacy Policy or the  handling of your personal information, please contact us at contact@StayChain.com.</p>
                                ...
                                <div className="box-share-us">
                                    ...
                                    <p className="text-lg-bold neutral-1000">Stay Chain Team</p>
                                </div>
                            </div>
                        </div>
                    </section>
