			...
			{/* <Layout headerStyle={1} footerStyle={1}> */}
				<main className="main">
									...
									<div className="box-grid-property wow fadeIn">
										<div className="row">
											{paginatedProperties.map((property) => (
												<div className="col-lg-4 col-md-6 wow fadeInUp" key={property.id}>
					...
					<section className="section-box block-ads background-body">
						<div className="container wow fadeInUp"> <img src="/assets/imgs/page/homepage9/banner-ads.png" alt="StayChain" /></div>
					</section>
