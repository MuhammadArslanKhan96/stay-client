							...
							<div className="row align-items-end">
								<div className="col-lg-7 wow fadeInUp"> <span className="btn btn-brand-secondary"> <img className="mr-10" src="/assets/imgs/page/homepage9/real.svg" alt="Travile" />Resort Real Estate</span>
									<h1 className="neutral-1000 mt-15 mb-15">
										Welcome<span>to Stay Chain  </span>Stay Chain  <span>booking system</span></h1>
					...
					<section className="section-box box-why-book-travila-5 background-5">
						<div className="container">
							<div className="row align-items-center">
								<div className="col-lg-6 mb-30"><span className="btn btn-brand-secondary background-0 wow fadeInUp"> <img className="mr-10" src="/assets/imgs/page/homepage4/earth.svg" alt="Travile" />Why book at Stay Chain ?</span>
						...
						<div className="container">
							<div className="row align-items-end">
								<div className="col-lg-6 mb-30 wow fadeInUp">
									<div className="box-author-testimonials button-brand-2 wow fadeInUp"> <img src="/assets/imgs/page/homepage1/testimonial.png" alt="StayChain" /><img src="/assets/imgs/page/homepage1/testimonial2.png" alt="StayChain" /><img src="/assets/imgs/page/homepage1/testimonial3.png" alt="StayChain" />Our Team</div>
								...
								<div className="row">
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team6.png" alt="StayChain" /></div>
											<div className="card-info">
												<h6 className="neutral-1000">Cody Fisher</h6>
												<p className="text-sm-medium neutral-500">Founder and Principal Broker</p>
												<p className="text-xs-medium neutral-1000">With over 15 years of real estate experience, John leads the Stay Chain team with passion and expertise. His commitment to client satisfaction and market knowledge sets the standard for our exceptional service.</p>
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team.png" alt="StayChain" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team2.png" alt="StayChain" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team3.png" alt="StayChain" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team4.png" alt="StayChain" /></div>
											<div className="card-info">
									...
									<div className="col-lg-4 col-md-6 wow fadeInUp">
										<div className="card-team card-team-2">
											<div className="card-image"> <img src="/assets/imgs/page/pages/team5.png" alt="StayChain" /></div>
											<div className="card-info">
