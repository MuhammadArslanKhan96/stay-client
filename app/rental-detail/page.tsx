							...
							<div className="container-banner-activities">
								<div className="box-banner-activities">
									<Slider {...settingsMain} ref={slider1} className="banner-activities-detail">
										<div className="banner-slide-activity"><img src="/assets/imgs/page/car/banner2.png" alt="StayChain" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/car/banner2.png" alt="StayChain" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/car/banner2.png" alt="StayChain" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/car/banner2.png" alt="StayChain" /></div>
										<div className="banner-slide-activity"><img src="/assets/imgs/page/car/banner2.png" alt="StayChain" /></div>
								...
								<div className="slider-thumnail-activities">
									<Slider {...settingsThumbs} ref={slider2} className="slider-nav-thumbnails-activities-detail">
										<div className="banner-slide"><img src="/assets/imgs/page/car/banner-thumn.png" alt="StayChain" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/car/banner-thumn2.png" alt="StayChain" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/car/banner-thumn3.png" alt="StayChain" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/car/banner-thumn4.png" alt="StayChain" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/car/banner-thumn5.png" alt="StayChain" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/car/banner-thumn6.png" alt="StayChain" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/car/banner-thumn.png" alt="StayChain" /></div>
										<div className="banner-slide"><img src="/assets/imgs/page/car/banner-thumn3.png" alt="StayChain" /></div>
									</Slider>
								</div>
						...
						<div className="container">
							...
							<div className="row mt-30">
										...
										<div className="list-feature-car">
											<div className="item-feature-car">
												<div className="item-feature-car-inner">
													<div className="feature-image"> <img src="/assets/imgs/page/car/km.png" alt="StayChain" /></div>
											...
											<div className="item-feature-car">
												<div className="item-feature-car-inner">
													<div className="feature-image"> <img src="/assets/imgs/page/car/diesel.png" alt="StayChain" /></div>
													<div className="feature-info">
											...
											<div className="item-feature-car">
												<div className="item-feature-car-inner">
													<div className="feature-image"> <img src="/assets/imgs/page/car/auto.png" alt="StayChain" /></div>
													<div className="feature-info">
											...
											<div className="item-feature-car">
												<div className="item-feature-car-inner">
													<div className="feature-image"> <img src="/assets/imgs/page/car/seat.png" alt="StayChain" /></div>
													<div className="feature-info">
											...
											<div className="item-feature-car">
												<div className="item-feature-car-inner">
													<div className="feature-image"> <img src="/assets/imgs/page/car/bag.png" alt="StayChain" /></div>
													<div className="feature-info">
											...
											<div className="item-feature-car">
												<div className="item-feature-car-inner">
													<div className="feature-image"> <img src="/assets/imgs/page/car/suv.png" alt="StayChain" /></div>
													<div className="feature-info">
											...
											<div className="item-feature-car">
												<div className="item-feature-car-inner">
													<div className="feature-image"> <img src="/assets/imgs/page/car/door.png" alt="StayChain" /></div>
													<div className="feature-info">
											...
											<div className="item-feature-car">
												<div className="item-feature-car-inner">
													<div className="feature-image"> <img src="/assets/imgs/page/car/lit.png" alt="StayChain" /></div>
													<div className="feature-info">
													...
													<div className="head-reviews">
														<div className="review-left">
															<div className="review-info-inner">
																...
																<div className="review-rate"> <img src="/assets/imgs/page/tour-detail/star.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star.svg" alt="StayChain" /></div>
															</div>
														</div>
													...
													<div className="list-reviews">
														<div className="item-review">
															<div className="head-review">
																<div className="author-review"> <img src="/assets/imgs/page/tour-detail/avatar.png" alt="StayChain" />
																	<div className="author-info">
																		<p className="text-lg-bold">Sarah Johnson</p>
																		<p className="text-sm-medium neutral-500">December 4, 2024 at 3:12 pm</p>
																	</div>
																</div>
																<div className="rate-review"> <img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /></div>
															</div>
														...
														<div className="row">
															<div className="col-lg-4">
																<div className="box-type-review">
																	...
																	<p className="rate-type-review"> <img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="StayChain" /></p>
																</div>
																<div className="box-type-review">
								...
								<div className="col-lg-4">
										...
										<div className="box-sidebar-content">
											<div className="box-agent-support">
												<div className="card-author">
													<div className="card-author-image"> <img src="/assets/imgs/page/property/author.png" alt="StayChain" /></div>
									...
									<div className="sidebar-banner"> <Link href="#"><img src="/assets/imgs/page/car/banner-ads.png" alt="StayChain" /></Link></div>
								</div>
							</div>
						</div>
					</section>
						...
						<div className="container">
							<div className="row">
								<div className="col-lg-6">
									...
									<div className="box-image-how wow fadeInUp"> <img src="/assets/imgs/page/homepage8/img-how.png" alt="StayChain" /><span className="img-arrow"> <img src="/assets/imgs/page/homepage8/img-arrow.png" alt="StayChain" /></span><span className="img-dot"> <img src="/assets/imgs/page/homepage8/dot-img.png" alt="StayChain" /></span></div>
								</div>
								<div className="col-lg-6">
								...
								<div className="row">
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage8/service.png" alt="StayChain" /></Link></div>
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage8/service2.png" alt="StayChain" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage8/service3.png" alt="StayChain" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
									...
									<div className="col-xl-3 col-lg-4 col-md-6 wow fadeInDown">
										<div className="card-spot background-card">
											<div className="card-image"> <Link href="#"><img src="/assets/imgs/page/homepage8/service4.png" alt="StayChain" /></Link></div>
											<div className="card-info background-card">
												<div className="card-left">
