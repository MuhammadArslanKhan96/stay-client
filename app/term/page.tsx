                        ...
                        <div className="container">
                            <div className="box-mw-824">
                                <div className="text-center">
                                    ...
                                    <h2 className="mt-15 mb-15 neutral-1000 wow fadeInUp">Terms Of Service</h2>
                                    <p className="text-xl-medium neutral-1000 mb-55 wow fadeInUp">Last update: Mar 17, 2024</p>
                                </div>
                            </div>
                            <div className="box-mw-824">
                                <div className="box-detail-info">
                                    <p className="neutral-1000">Welcome to Stay Chain! Before you begin using our platform, please take a  moment to review the terms and conditions that govern your use of our  website and services.</p>
