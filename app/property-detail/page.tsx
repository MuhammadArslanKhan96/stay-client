											...
											<ul>
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/property/feature.png" alt="StayChain" /></Link></div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/property/feature2.png" alt="StayChain" /></Link></div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/property/feature3.png" alt="StayChain" /></Link></div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/property/feature4.png" alt="StayChain" /></Link></div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="#"> <img src="/assets/imgs/page/property/feature5.png" alt="StayChain" /></Link></div>
								...
								<div className="col-lg-4 col-md-6 wow fadeInUp">
									<div className="card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card">
										<div className="card-image"> <Link className="wish" href="#">
											...
											</svg></Link><img src="/assets/imgs/page/property/like.png" alt="StayChain" /></div>
								...
								<div className="col-lg-4 col-md-6 wow fadeInUp">
									<div className="card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card">
										<div className="card-image"> <Link className="wish" href="#">
											<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
												<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
											</svg></Link><img src="/assets/imgs/page/property/like2.png" alt="StayChain" /></div>
										<div className="card-info">
											<div className="card-rating">
												<div className="card-left"> </div>
												<div className="card-right"> <span className="rating">4.96 <span className="text-sm-medium neutral-500">(672 reviews)</span></span></div>
								...
								<div className="col-lg-4 col-md-6 wow fadeInUp">
									<div className="card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card">
										<div className="card-image"> <Link className="wish" href="#">
											<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
												<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
											</svg></Link><img src="/assets/imgs/page/property/like3.png" alt="StayChain" /></div>
										<div className="card-info">
											<div className="card-rating">
												<div className="card-left"> </div>
												<div className="card-right"> <span className="rating">4.96 <span className="text-sm-medium neutral-500">(672 reviews)</span></span></div>
