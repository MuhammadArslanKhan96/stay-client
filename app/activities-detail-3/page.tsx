					...
					<section className="box-section box-content-tour-detail background-body">
						...
						<div className="container position-relative">
							...
							<div className="banne-activities-3">
								<div className="banner-col-1"> <img src="/assets/imgs/page/activities/banner2.png" alt="StayChain" /></div>
								<div className="banner-col-2"> <img src="/assets/imgs/page/activities/banner3.png" alt="StayChain" /></div>
								<div className="banner-col-3"> <img src="/assets/imgs/page/activities/banner4.png" alt="StayChain" /></div>
							</div>
						</div>
						<div className="container">
