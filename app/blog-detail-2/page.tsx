											...
											<div className="content-detail-post">
												...
												<div className="box-list-comment background-card">
													<div className="list-reviews">
														...
														<div className="item-review">
															<div className="head-review">
																<div className="author-review"> <img src="/assets/imgs/page/blog/avatar.png" alt="StayChain" />
																	<div className="author-info">
																		<p className="text-lg-bold">Sarah Johnson</p>
																		<p className="text-sm-medium neutral-500">December 4, 2024 at 3:12 pm</p>
																	</div>
														...
														<div className="item-review">
															<div className="head-review">
																<div className="author-review"> <img src="/assets/imgs/page/blog/avatar2.png" alt="StayChain" />
																	<div className="author-info">
																		<p className="text-lg-bold">Sarah Johnson</p>
																		<p className="text-sm-medium neutral-500">December 4, 2024 at 3:12 pm</p>
																	</div>
											...
											<ul className="list-posts">
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail-2"><img src="/assets/imgs/page/blog/trending.png" alt="StayChain" /></Link></div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail-2"><img src="/assets/imgs/page/blog/trending2.png" alt="StayChain" /></Link></div>
														<div className="card-info"> <Link className="text-md-bold neutral-1000" href="/blog-detail-2">Beyond the Pixels: My Art-Tech Lifestyle Journey</Link>
															<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
														</div>
													</div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail-2"><img src="/assets/imgs/page/blog/trending3.png" alt="StayChain" /></Link></div>
														<div className="card-info"> <Link className="text-md-bold neutral-1000" href="/blog-detail-2">Beyond the Pixels: My Art-Tech Lifestyle Journey</Link>
															<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
														</div>
													</div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail-2"><img src="/assets/imgs/page/blog/trending4.png" alt="StayChain" /></Link></div>
														<div className="card-info"> <Link className="text-md-bold neutral-1000" href="/blog-detail-2">Beyond the Pixels: My Art-Tech Lifestyle Journey</Link>
															<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
														</div>
													</div>
												...
												<li>
													<div className="card-post">
														<div className="card-image"> <Link href="/blog-detail-2"><img src="/assets/imgs/page/blog/trending5.png" alt="StayChain" /></Link></div>
														<div className="card-info"> <Link className="text-md-bold neutral-1000" href="/blog-detail-2">Beyond the Pixels: My Art-Tech Lifestyle Journey</Link>
															<p className="text-sm-medium date-post neutral-500">18 Sep 2024</p>
														</div>
													</div>
												...
												<div className="card-news background-card hover-up">
													<div className="card-image">
														<label className="label">Cultural</label><Link className="wish" href="#">
															...
															</svg></Link><img src="/assets/imgs/page/homepage1/news.png" alt="StayChain" />
													</div>
												...
												<div className="card-news background-card hover-up">
													<div className="card-image">
														<label className="label">Travel</label><Link className="wish" href="#">
															<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
																<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
															</svg></Link><img src="/assets/imgs/page/homepage1/news2.png" alt="StayChain" />
													</div>
													<div className="card-info">
														<div className="card-meta"> <span className="post-date neutral-1000">18 Sep 2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
												...
												<div className="card-news background-card hover-up">
													<div className="card-image">
														<label className="label">Discovery</label><Link className="wish" href="#">
															<svg width={20} height={18} viewBox="0 0 20 18" xmlns="http://www.w3.org/2000/svg">
																<path d="M17.071 10.1422L11.4141 15.7991C10.6331 16.5801 9.36672 16.5801 8.58568 15.7991L2.92882 10.1422C0.9762 8.1896 0.9762 5.02378 2.92882 3.07116C4.88144 1.11853 8.04727 1.11853 9.99989 3.07116C11.9525 1.11853 15.1183 1.11853 17.071 3.07116C19.0236 5.02378 19.0236 8.1896 17.071 10.1422Z" stroke="" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
															</svg></Link><img src="/assets/imgs/page/homepage1/news3.png" alt="StayChain" />
													</div>
													<div className="card-info">
														<div className="card-meta"> <span className="post-date neutral-1000">18 Sep 2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
